...
public class Graph extends UIContainer {
    ...
    public Graph(UIContainer parent, Supplier<Locator> getFunction) {
        super(parent, getFunction);
    }

    public GraphNode getNodeById(String id) {
        return new GraphNode(this, () -> locator().locator(".x6-cell", new Locator.LocatorOptions().setHas(locator().locator("*[data-cell-id=" + id + "]"))));
    }
